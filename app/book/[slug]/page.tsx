...
import { CheckCircle2, ChevronLeft, CalendarDays, Clock, MapPin } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function BookingFlowPage({ params }: { params: { slug: string } }) {
  ...
  const doctor = {
    ...
    photoUrl: "https://ui-avatars.com/api/?name=Ahmed+Al+Mansouri&background=2200CC&color=fff&size=256",
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {step < 3 && (
          <div className="mb-6 flex items-center">
            <Link href={`/doctors/${params.slug}`} className="flex items-center text-text-mid hover:text-blue-primary font-medium text-sm transition-colors">
        ...
        {/* Doctor Summary Card (Always visible in steps 1 & 2) */}
        {step < 3 && (
          ...
          <div className="bg-white border border-gray-border rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            <form className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="John Doe" className="w-full bg-gray-bg border border-gray-border rounded-xl h-12 px-4 text-sm font-medium text-text-dark focus:outline-none focus:border-blue-primary focus:ring-1 focus:ring-blue-primary" />
              </div>
              
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex flex-col gap-2 flex-1">
                  <label className="text-sm font-semibold text-text-dark">Email <span className="text-red-500">*</span></label>
                  <input type="email" placeholder="john@example.com" className="w-full bg-gray-bg border border-gray-border rounded-xl h-12 px-4 text-sm font-medium text-text-dark focus:outline-none focus:border-blue-primary focus:ring-1 focus:ring-blue-primary" />
                </div>
                <div className="flex flex-col gap-2 flex-1">
                  <label className="text-sm font-semibold text-text-dark">Phone Number <span className="text-red-500">*</span></label>
                  <div className="flex">
                    <select className="bg-gray-bg border border-gray-border border-r-0 rounded-l-xl h-12 px-3 text-sm font-medium text-text-dark focus:outline-none">
                      <option>+971</option>
                      <option>+966</option>
                      <option>+965</option>
                    </select>
                    <input type="tel" placeholder="50 123 4567" className="w-full bg-gray-bg border border-gray-border rounded-r-xl h-12 px-4 text-sm font-medium text-text-dark focus:outline-none focus:border-blue-primary focus:ring-1 focus:ring-blue-primary" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <select className="w-full appearance-none bg-gray-bg border border-gray-border rounded-xl h-12 px-4 text-sm font-medium text-text-dark focus:outline-none focus:border-blue-primary focus:ring-1 focus:ring-blue-primary">
              ...
              <div className="flex flex-col gap-2 mb-4">
                ...
                <textarea rows={3} placeholder="Briefly describe your symptoms..." className="w-full bg-gray-bg border border-gray-border rounded-xl p-4 text-sm font-medium text-text-dark focus:outline-none focus:border-blue-primary focus:ring-1 focus:ring-blue-primary resize-none"></textarea>
              </div>
              ...
              <div className="flex justify-between items-center pt-6 border-t border-gray-border">
                ...
                <Button 
                  type="button"
                  onClick={handleNextStep} 
                  className="bg-blue-primary hover:bg-blue-hover text-white h-12 px-8 rounded-xl font-bold text-base w-full sm:w-auto shadow-md shadow-blue-primary/20"
                >
                  Confirm Booking
                </Button>
              </div>
