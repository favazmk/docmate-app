      ...
      <div className="max-w-7xl mx-auto px-4 w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 flex flex-col gap-3">
            ...
            <Link href="/data-protection-policy" className="text-white/50 hover:text-white transition-colors text-sm">Data protection</Link>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-white/30 text-xs">
          ...
          <p className="flex items-center gap-1.5">
            Site by <a href="https://thewebbranding.com" target="_blank" rel="noopener noreferrer" className="hover:text-purple-500 transition-colors font-medium">Web Branding</a>
          </p>
        </div>
      </div>
    </footer>
